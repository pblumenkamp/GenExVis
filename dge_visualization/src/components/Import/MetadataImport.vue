...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      // managing initialization of gff3 feature select upon opening slider 4 in ImportMain.vue
      // bound to view via v-if directive in multiselect
      catch4dropDownEvent(){
        // eslint-disable-next-line no-console
        console.log('in computed of MetadataImport');
        this.$root.$on('hello', (dropDown4clicked) =>{
          // eslint-disable-next-line no-console
          console.log('in event listener');
          // eslint-disable-next-line no-console
          console.log(dropDown4clicked);
